      ...
      <section id="atuacao" className="bg-white py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-[1.5rem] border border-[#ece4d8] bg-[#fcfaf7] p-6">
              <h3 className="text-xl font-semibold">Execução</h3>
              <p className="mt-3 leading-7 text-[#5c534a]">
                Escritório especializado em execução de dívida, defesa para 
                devedores e cobrança para credores, focando em dívidas bancárias
                e cívis.
              </p>
            </div>
